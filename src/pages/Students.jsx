...
<<<<<<< HEAD
              <div className="col-span-2 flex items-center justify-end gap-1 md:opacity-0 group-hover:opacity-100 transition-opacity">
                ...
                <Link to={`/students/${student.id}`} state={{ student }} className="p-2 text-gray-400 hover:text-primary-600 hover:bg-primary-50 rounded-lg transition-colors" title="View Profile">
                  <Eye className="h-4 w-4" />
                </Link>
                <button onClick={() => openEditModal(student)} className="p-2 text-gray-400 hover:text-warning-dark hover:bg-warning/10 rounded-lg transition-colors" title="Edit Student">
